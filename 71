...
const paths = {
  scssParts: `${srcFolder}/parts/**/**/**`,
  srcScss: `${srcFolder}/scss/**/*.scss`,
  srcScssSetings: `${srcFolder}/setings/**/*.scss`,
  scssPartsHtml: `${srcFolder}/parts/**/**/*.html`,
  ...
  srcPartialsFolder: `${srcFolder}/parts`,
...
const watchFiles = () => {
  ...
  watch(paths.scssPartsHtml, htmlInclude);
  watch(paths.scssParts, styles);
  watch(paths.srcScss, styles);
  watch(paths.srcScssSetings, styles);
...
// --- tasks ---
// exports.name_task = name_funk();
//series(name_funk, name_funk, name_funk); - let several funk;
